...
InverseMultiquadrics::InverseMultiquadrics()
{
    smooth = 0.025;
}

void InverseMultiquadrics::computePhi(double *center, double *vertex, double *ret)
{
    double p[3];
    ...
    *ret  = 1/sqrt(t2 + smooth*smooth);


}
void InverseMultiquadrics::gradient(double *center, double *vertex, double grad[3])
{
    double p[3];
    p[0] = vertex[0] - center[0];
    p[1] = vertex[1] - center[1];
...
void InverseMultiquadrics::hessian(double *center, double *vertex, double hess[3][3])
{
    double p[3];
    p[0] = vertex[0] - center[0];
    p[1] = vertex[1] - center[1];
