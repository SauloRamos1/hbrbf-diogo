...
//        "rbf_coelho_ID7_Ciclo5_1",
 ...
 //       "rbf_coelho_ID2_Ciclo7"
    ...
    "rbf_ovelha_ID7_Ciclo9_2",
    "rbf_ovelha_ID2_Ciclo3",
    "rbf_ovelha_ID2_Ciclo10",
    "rbf_ovelha_ID3_Ciclo0_1",
    "rbf_ovelha_ID3_Ciclo0_2",
    "rbf_ovelha_ID3_Ciclo4_1",
    "rbf_ovelha_ID3_Ciclo4_2",
    "rbf_ovelha_ID7_Ciclo8_1",
    "rbf_ovelha_ID7_Ciclo8_2",
    "rbf_ovelha_ID7_Ciclo9_1"
    ...
    for(int i = 0; i <73 ; i++)
    {
        ...
        //radius in 0... 1
        rbf->radius = 1000;//radius[i] ;//radius[pos];
